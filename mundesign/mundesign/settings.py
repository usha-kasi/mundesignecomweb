"""
Django settings for mundesign project.
...
#SECRET_KEY = 'django-insecure-k2%5-t(8h-!7@6ew=ikw6e!*mrnah_%*cxz!hq^(hhom6lvw%!'
...
WSGI_APPLICATION = 'mundesign.wsgi.application'
